...
<?php if(isset($images)){foreach($images as $value){ ?>
    <img style="margin-top:5%" height="200px" width="200px" class="img-thumbnail" src="<?php echo BASE; ?>/img/<?php echo $value['image1'] ?>">

<form action="<?php echo BASE; ?>/Product/updatefront/<?php echo base64_encode($value['image1']); ?>/<?php echo base64_encode($value['id']); ?>" method="post" enctype="multipart/form-data">
<div class="col-sm-4">
</div>
    <div >
