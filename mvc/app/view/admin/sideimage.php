...
<?php if(isset($images)){foreach($images as $value){ ?>
    <img style="margin-top:5%" height="200px" width="200px" class="img-thumbnail" src="<?php echo BASE; ?>/img/<?php echo $value['image2'] ?>">

<form action="<?php echo BASE; ?>/Product/updateside/<?php echo base64_encode($value['image2']); ?>/<?php echo base64_encode($value['id']); ?>" method="post" enctype="multipart/form-data">
<div class="col-sm-4">
</div>
