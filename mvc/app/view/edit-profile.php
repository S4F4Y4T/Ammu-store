			...
			<div class="cartpage">
						<table class="tblone" style="width: 50%;margin: 0 auto;border: 1px solid #ccc;color:#3F3F3F">
							...
							<tr>
								<td>Name</td>
								<td>:</td>
								<td><input type="text" name='name' value="<?= $value['username']; ?>" onfocus="this.value = '<?= $value['name']; ?>';"></td>
							</tr>
							<tr>
								<td>Phone</td>
								<td>:</td>
								<td><input type="text" name='phone' value="<?= $value['phone']; ?>" onfocus="this.value = '<?= $value['phone']; ?>';"></td>
							</tr>
							<tr>
								<td>Country</td>
								<td>:</td>
								<td>
								    <select style="width: 90%;" id="country" name="country" onchange="change_country(this.value)" class="frm-field required">
 					 <?php
                        $Countries = [
                        ...
                        ?>
							...
							<tr>
								<td>City</td>
								<td>:</td>
								<td><input type="text" name='city' value="<?= $value['city']; ?>" onfocus="this.value = '<?= $value['city']; ?>';"></td>
							</tr>
							<tr>
								<td>Address</td>
								<td>:</td>
								<td><input type="text" name='address' value="<?= $value['address']; ?>" onfocus="this.value = '<?= $value['address']; ?>';"></td>
							</tr>
							<tr>
								<td>Zip</td>
								<td>:</td>
								<td><input type="text" name='zip' value="<?= $value['zip']; ?>" onfocus="this.value = '<?= $value['zip']; ?>';"></td>
							</tr>
							<tr>
								<td>Email</td>
								<td>:</td>
								<td><input type="text" name='email' value="<?= $value['email']; ?>" onfocus="this.value = '<?= $value['email']; ?>';" readonly></td>
							</tr>
							<?php }} ?>
							 <tr>
							     <td></td>
							     <td><button style="cursor: pointer;" class="login"><a href="">update</a></button> </td>
							    <td></td>
							 </tr>
							</form>
							</table>
